...
function ProduitForm({addProds:addproduit}) {
	...
	const ajouter = (p) => {
		...
		if (data['name'] == ' '){
			...
			// liste_local = produits.produits;
			// liste_local.push({id:produits.length, name:data['name'],quantity: data['quantity'],description: data['description']});
			// console.log(setProduits);
			// console.log(addproduit);
			// addProduit.setProduits();
			// addProduit([]);
			// setProduits({...produits.produits ,id:produits.length, name:data['name'],quantity: data['quantity'],description: data['description']});
			// console.log("liste_local:",liste_local);
			// console.log("setProduits:",setProduits);
			// setProduits({liste_local});
			// console.log(setProduit);
			// setProduit('test');
			// setProduit({p, name:data['name'],quantity: data['quantity'],description: data['description']});
			addproduit(data);
		}
